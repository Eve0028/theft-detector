...
- **Grupa eksperymentalna („Złodziej”):** Uczestnik wchodzi do pokoju, patrzy do pudełka, dokładnie ogląda znajdujący się tam przedmiot i „kradnie” go (w tym przypadku pluszaka) - chowając go do plecaka/torby. 
    
- **Grupa kontrolna:** Uczestnik wchodzi do tego samego pokoju jedynie w celu podpisania się na liście obecności. Nie zagląda do pudełka i nie zna jego zawartości.

### 2. Sesja EEG i paradygmat badawczy
Po etapie wprowadzającym następuje właściwy pomiar EEG. Uczestnik zakłada czepek BrainAccess i wykonuje zadanie komputerowe składające się z ok. **400 prób** (ok. 21 minut czystego pomiaru).
...
Głównym założeniem jest to, że u osób z grupy „złodziei” prezentacja przedmiotu skradzionego (S1-Probe) wywoła znacznie wyższą amplitudę fali **P300** (w przedziale 300–600 ms lub zbliżonym) niż przedmioty neutralne. Analiza statystyczna metodą **BAD** (Bootstrapped Amplitude Difference) oraz metody ML pozwolą ocenić, czy różnica ta jest na tyle wyraźna, by przy użyciu taniego sprzętu EEG skutecznie odróżnić „sprawcę” od osoby niewinnej.