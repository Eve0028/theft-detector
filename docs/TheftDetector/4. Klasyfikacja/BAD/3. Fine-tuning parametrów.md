...
### A) Globalną optymalizację hiperparametrów za pomocą metryki AUC

### B) Niezależną, międzyosobniczą ewaluację progu decyzyjnego w rygorze LOO-CV

<br>

## 3. Optymalizacja parametrów jest wykonywana przez Optune na podstawie **AUC**
...
## 4. LOO (Leave One Out) CV (wewnątrz triala optuny) - Pipeline wyliczania 'threshold' i 'metryk końcowych'
